...
export const GiftIcon = ({ className = "", size = 20 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 7H7.5a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 2a4.8 8 0 0 1 4.5 0 2.5 2.5 0 0 1 0 5H12"/>
  </svg>
); 
...
export const StarIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <polygon points="12 2 15 8.5 22 9 17 13.5 18.5 20.5 12 17 5.5 20.5 7 13.5 2 9 9 8.5 12 2" />
  </svg>
);
